...
export const SketeboardProduct = async ({ id }: Props) => {
    const client = createClient()
    const product = await client.getByID<Content.SketeboardDocument>(id)
    ...
    return (
        <div className='group relative mx-auto w-full max-w-72 px-8 pt-4'>
            ...
            <div className='flex flex-row items-center justify-between ~text-sm/2xl'>
                <span>{price}</span>
            ...
            <div className='-mb-1 overflow-hidden py-4'>
                ...
                <PrismicNextImage alt='' field={product.data.image}
                 width={150} className='mx-auto w-[58%]  origin-top transform-gpu transition-transform
